...
export default function Navbar(){
    return (
        <nav className="flex flex-row w-screen h-12 items-center px-2 border-b-2 fixed top-0">
            ...
            <div className="flex-grow p-1 flex justify-center" id="navbar-mid">
                <div className="border-2 w-11/12 px-1 rounded-full flex flex-row items-center">
